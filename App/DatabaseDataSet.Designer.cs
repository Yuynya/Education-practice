...
namespace App {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class CategoryDataTable : global::System.Data.TypedTableBase<CategoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CategoryRow AddCategoryRow(int Id, string CName) {
...
namespace App.DatabaseDataSetTableAdapters {
    ...
    public partial class CategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Category] WHERE (([Id] = @Original_Id) AND ([CName] = @Origina" +
                "l_CName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Category] ([Id], [CName]) VALUES (@Id, @CName);\r\nSELECT Id, CN" +
                "ame FROM Category WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Category] SET [Id] = @Id, [CName] = @CName WHERE (([Id] = @Original" +
                "_Id) AND ([CName] = @Original_CName));\r\nSELECT Id, CName FROM Category WHERE (Id" +
                " = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, CName FROM dbo.Category";
        ...
        public virtual int Insert(int Id, string CName) {
        ...
        public virtual int Update(int Id, string CName, int Original_Id, string Original_CName) {
        ...
        public virtual int Update(string CName, int Original_Id, string Original_CName) {
            return this.Update(Original_Id, CName, Original_Id, Original_CName);
        }
    }
